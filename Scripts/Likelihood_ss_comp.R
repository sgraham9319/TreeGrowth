...
# Find rare competitor species (appear <100 times as neighbors)
rare_comp <- names(which(table(sing_sp$sps_comp) < 100))

# Change rare competitor species names to other (OTHR)
sing_sp <- sing_sp %>%
